...
local function Kill(Model)
    if _G.Code1 ~= nil and _G.Code2 ~= nil and Model:FindFirstChild("Torso") then
        ...
        if WaitForGun then
            repeat
                wait()
            until game.Players.LocalPlayer.Character:FindFirstChild(ReplacementGun)
        end
        game.Workspace.ServerStuff.claimItem:InvokeServer(game.Players.LocalPlayer.Character:FindFirstChildOfClass(
            "Model"))
...
local function HealOnce()
    if _G.Code1 ~= nil and _G.Code2 ~= nil then
        local AnimSet = game:GetService("ReplicatedStorage").animationSets.TPanimSets:FindFirstChild(
            WeaponStats["HStim"].animset)
        game.Workspace.ServerStuff.getTPWeapon:FireServer("HStim", AnimSet, "Fist", nil, false)
        repeat
            wait()
        until game.Players.LocalPlayer.Character:FindFirstChild("HStim")
...
local function ApplyGod(ungod)
    ...
    repeat
        game.Workspace.ServerStuff.getTPWeapon:FireServer("ImpN", AnimSet, "Fist", nil, false)
        wait()
    until game.Players.LocalPlayer.Character:FindFirstChild("ImpN")
    local Previous = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
        CFrame.new(243.9402313232422, 26.216890335083008, -201.4144744873047)
    local Target = CFrame.new(243.940231, 27.7168903, -201.414474, -1, 2.27966084e-05, -4.12229565e-06, 0, 0.177943438,
        0.984040737, 2.31663253e-05, 0.984040737, -0.177943438)
    ...
    if ungod == true then
        if game.Players.LocalPlayer.Character ~= nil and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") then
            Damage = game.Players.LocalPlayer.Character.Humanoid.Health -
    ...
    wait(0.3)
    workspace.ServerStuff.throwWeapon:FireServer("ImpN", 0, Target, 0.19530236721038818, Data, 1, false, _G.Code1, nil,
        _G.Code2)
    wait(0.5)
...
local function StatusAdded(new)
    ...
    if new:IsA("Frame") and EffectsTable ~= nil and EffectsTable[new.Name] ~= nil and not string.find(new.Name, "Virus") then
        if EffectsTable[new.Name].effects ~= nil and EffectsTable[new.Name].effects.currentduration ~= nil and
            EffectsTable[new.Name].effects.colour ~= nil then
            if EffectsTable[new.Name].effects.colour == Color3.new(1, 0.05, 0.05) or
                EffectsTable[new.Name].effects.colour == false or new.Name == "Burning" or new.Name == "Exhaustion" then
...
local function EspHandle(v)
    if v.Name == "ai_type" and v:IsA("StringValue") and EspInfo.Scavs[v.Value] ~= nil then
        repeat
            wait()
        until v.Parent == nil or v.Parent:FindFirstChild("Head")
...
local function SetupGUI()
    ...
    repeat
        wait()
    until game.Players.LocalPlayer.PlayerGui.mainHUD:FindFirstChild("TabMenu")
    repeat
        wait()
    until game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu:FindFirstChild("bg")
    if game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg:FindFirstChild("GOODWILL") then
        return
    end
    repeat
        wait()
    until game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg:FindFirstChild("rations")
    repeat
        wait()
    until game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg:FindFirstChild("ammodrop")
    repeat
        wait()
    until game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg:FindFirstChild("weaponinfo")
    repeat
        wait()
    until game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg:FindFirstChild("scrap")
    repeat
        wait()
    until game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg:FindFirstChild("rationstab")
    repeat
        wait()
    until game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg:FindFirstChild("scraptab")
    repeat
        wait()
    until game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg:FindFirstChild("weaponinfotab")
    repeat
        wait()
    until game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg.weaponinfotab:FindFirstChild("founditem")
    repeat
        wait()
    until game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg.scraptab:FindFirstChild("lessbutton")
    repeat
        wait()
    until game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg.scraptab:FindFirstChild("morebutton")
    repeat
        wait()
    until game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg.rationstab:FindFirstChild("Soda")
    repeat
        wait()
    until game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg.rationstab.Soda:FindFirstChild("drop")
    repeat
        wait()
    until game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg.rationstab.Soda:FindFirstChild("desc")
    ...
    local MoreButton = game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg.scraptab:FindFirstChild("morebutton")
        :Clone()
    MoreButton.Size = UDim2.new(0.05, 0, 0.084, 0)
    local LessButton = game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg.scraptab:FindFirstChild("lessbutton")
        :Clone()
    ...
    GoodwillButton.MouseButton1Down:Connect(function()
        ...
        for i, v in pairs(game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg:GetChildren()) do
            if string.sub(string.lower(v.Name), #v.Name - 2, -1) == "tab" and v.Name ~= "GOODWILLtab" and v.Name ~=
                "objectivetab" then
                v.Visible = false
    ...
    ESPButton.MouseButton1Down:Connect(function()
        MenuEffect()
        for i, v in pairs(game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg:GetChildren()) do
            if string.sub(string.lower(v.Name), #v.Name - 2, -1) == "tab" and v.Name ~= "ESPtab" and v.Name ~=
                "objectivetab" then
                v.Visible = false
    ...
    repeat
        wait()
    until game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg.weaponinfotab.founditem:FindFirstChild("line1")
    repeat
        wait()
    until game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg.weaponinfotab.founditem:FindFirstChild("line2")
    repeat
        wait()
    until game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg.weaponinfotab.founditem:FindFirstChild("line3")
    repeat
        wait()
    until game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg.weaponinfotab.founditem:FindFirstChild("line4")
    repeat
        wait()
    until game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg.weaponinfotab.founditem:FindFirstChild("line5")
    repeat
        wait()
    until game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg.weaponinfotab.founditem:FindFirstChild("line6")
    repeat
        wait()
    until game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg.weaponinfotab.founditem:FindFirstChild("line7")
    repeat
        wait()
    until game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg.weaponinfotab.founditem:FindFirstChild("line8")

    repeat
        wait()
    until game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg.weaponinfotab:FindFirstChild("error_found")
                ...
                if NewMoreButton.icon.Text == "+" then
                    ...
                    if NameToStat[StatName].Index ~= nil then
                        ...
                        if Projected <= 0 then
                            ...
                            WeaponStats[ShownWeapon][StatPlacement.Stat] =
                                WeaponStats[ShownWeapon][StatPlacement.Stat] + StatPlacement.Increment
                        end
                    end
    ...
    repeat
        wait()
    until ShownWeapon ~= nil and ShownWeapon ~= ""
    ...
    if ShownWeapon ~= nil and ShownWeapon ~= "" then
        ...
        for i, v in pairs(FrameClone:GetChildren()) do
            if not string.find(v.Text, "DAMAGE") and string.find(v.Name, "line") and v.Name ~= "line1" and
                not string.find(v.Name, "more") and not string.find(v.Name, "less") then
    ...
    game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg.weaponinfotab.founditem:GetPropertyChangedSignal("Visible")
        :Connect(function()
                ...
                if NewMoreButton.icon.Text == "+" then
                    ...
                    if string.find(StatName, "DAMAGE") then
                        ...
                        WeaponStats[ShownWeapon]["damagerating"][Index] =
                            WeaponStats[ShownWeapon]["damagerating"][Index] + StatPlacement.Increment
                    else
                        if WeaponStats[ShownWeapon][StatPlacement.Stat .. "old"] == nil then
                            WeaponStats[ShownWeapon][StatPlacement.Stat .. "old"] =
                                WeaponStats[ShownWeapon][StatPlacement.Stat]
...
local function UpdateMiscWeaponry()
    ...
    if not game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg.weaponinfotab.FindFirstChild(game.Players.LocalPlayer
                                                                                                  .PlayerGui.mainHUD
                                                                                                  .TabMenu.bg
                                                                                                  .weaponinfotab,
        "AlternateFrame") then
    ...
    for x, y in pairs(game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg.weaponinfotab.AlternateFrame.GetChildren(
        game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg.weaponinfotab.AlternateFrame)) do
        if not string.find(y.Text, "DAMAGE") and string.find(y.Name, "line") and y.Name ~= "line1" and
            not string.find(y.Name, "more") and not string.find(y.Name, "less") and string.find(y.Text, ": ") then
            local Space2 = string.find(y.Text, ": ")
            local StatName2 = string.sub(y.Text, 2, Space2 - 1)
    ...
    if #CurrentWeaponStats["damagerating"] == 2 then
        game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg.weaponinfotab.AlternateFrame.line2.Text =
            ">LIMB_DAMAGE: " .. CurrentWeaponStats["damagerating"][1]
        game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg.weaponinfotab.AlternateFrame.line3.Text =
            ">HEAD_DAMAGE: " .. CurrentWeaponStats["damagerating"][2]
    elseif #CurrentWeaponStats["damagerating"] == 3 then
        game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg.weaponinfotab.AlternateFrame.line2.Text =
            ">LIMB_DAMAGE: " .. CurrentWeaponStats["damagerating"][3]
        game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg.weaponinfotab.AlternateFrame.line3.Text =
            ">HEAD_DAMAGE: " .. CurrentWeaponStats["damagerating"][3]
    elseif #CurrentWeaponStats["damagerating"] == 4 then
        game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg.weaponinfotab.AlternateFrame.line2.Text =
            ">LIMB_DAMAGE: " .. CurrentWeaponStats["damagerating"][3]
        game.Players.LocalPlayer.PlayerGui.mainHUD.TabMenu.bg.weaponinfotab.AlternateFrame.line3.Text =
            ">HEAD_DAMAGE: " .. CurrentWeaponStats["damagerating"][4]
    end
end
    ...
    if Method == "FireServer" then
        ...
        if tostring(self) == "throwWeapon" then
            if table.find(DevWeapons, tostring(Args[1])) then
                if game.Players.LocalPlayer.Character ~= nil and
                    game.Players.LocalPlayer.Character.FindFirstChild(game.Players.LocalPlayer.Character, "hasPrimary") then
                    if game.Players.LocalPlayer.Character.hasPrimary.FindFirstChild(
                        game.Players.LocalPlayer.Character.hasPrimary, Args[1]) then
        ...
        if tostring(self) == "dropAmmo" and Args[1] == "agent_container" and typeof(Args[2]) == "table" and
            typeof(Args[2][1]) == "table" then
        ...
        if tostring(self) == "dealDamage" and not checkcaller() then
            ...
            if Toggles.OneShot and typeof(Args[1]) == "table" and Args[1][2] ~= nil and
                string.find(tostring(Args[1][1]), "damage") and typeof(Args[1][2]) == "Instance" and
                Args[1][2].FindFirstChild(Args[1][2], "Humanoid") and Args[1][3] ~= nil and Args[1][3] ~= "shove" then
                if WeaponStats == nil and game.Workspace.FindFirstChild(game.Workspace, "ServerStuff") and
                    game.Workspace.ServerStuff.FindFirstChild(game.Workspace.ServerStuff, "Statistics") and
                    game.Workspace.ServerStuff.Statistics
                        .FindFirstChild(game.Workspace.ServerStuff.Statistics, "W_STATISTICS") then
                    WeaponStats = require(game.Workspace.ServerStuff.Statistics["W_STATISTICS"])
                end
                local WeaponInfo = WeaponStats[tostring(CurrentWeapon)] or nil
                local WeaponType = "Fists"
                ...
                for i = 1, math.floor((Args[1][2].Humanoid.Health / Args[1][3])) + 1 do
                    if WeaponType == "Gun" then
                        workspace.ServerStuff.dealDamage.FireServer(workspace.ServerStuff.dealDamage, "gunsareloud",
                            nil, _G.Code1, _G.Code2)
                    end
        ...
        if tostring(self) == "applyGore" then
            if string.find(tostring(Args[1]), "fire") and Args[4] ~= nil and typeof(Args[4]) == "table" and #Args[4] <=
                2 then
                return namecall(self, unpack(Args))
            end
            if string.find(tostring(Args[1]), "fire") and Args[4] ~= nil and typeof(Args[4]) == "table" and #Args[4] >=
                3 then
                local AnimSet = game.ReplicatedStorage.animationSets.TPanimSets.FindFirstChild(game.ReplicatedStorage
                                                                                                   .animationSets
                                                                                                   .TPanimSets,
                    WeaponStats[ShownWeapon].animset)
                game.Workspace.ServerStuff.getTPWeapon.FireServer(game.Workspace.ServerStuff.getTPWeapon, ShownWeapon,
                    AnimSet, "Fist", nil, false)
            end
            if Toggles.SilentAim and string.find(tostring(Args[1]), "fire") then
                if WeaponStats[CurrentWeapon] ~= nil and _G.Code1 ~= nil and _G.Code2 ~= nil then
                    ...
                    if not Toggles.OneShot then
                        game.Workspace.ServerStuff.dealDamage.FireServer(game.Workspace.ServerStuff.dealDamage,
                            FiringArgs, nil, _G.Code1, _G.Code2)
                    else
...
local function CommandHandler(msg, speaker)
    ...
    if IsInTable({"light", "small", "short", "medium", "heavy", "long", "shells", "scrap", "lit", "mre", "soda",
                  "beans", "water", "cola", "bottle"}, Args.Command) then
        ...
        elseif speaker ~= game.Players.LocalPlayer and Toggles.Dispenser and speaker.Character ~= nil and
            not Debounces.Dispensing and speaker.Character:FindFirstChild("HumanoidRootPart") then
...
--]]
    ...
    if IsInTable({"goodwill", "dispenser", "ammocommands", "ammo", "ungoodwill", "undispenser", "unammocommands",
                  "unammo"}, Args.Command) then
        local Toggle = true -- last second to default to true, rather than a toggle
        if Args[1] == "true" or Args[1] == "on" then
            Toggle = true
        elseif Args[1] == "false" or Args[1] == "off" or string.sub(Args.Command, 1, 2) == "un" then
    ...
    if IsInTable({"defectblock", "disabilityblock", "debuffsblock", "nodebuffs", "antidebuff", "antidebuffs",
                  "nodebuff", "noeffects", "nobleed", "undefectblock", "undisabilityblock", "undebuffsblock",
                  "unnodebuffs", "unnodebuff", "unantidebuff", "unantidebuffs", "unnobleed", "unnoeffects"},
        Args.Command) then
        local Toggle = true -- last second to default to true, rather than a toggle
        if Args[1] == "true" or Args[1] == "on" then
            Toggle = true
        ...
        if Toggle == true then
            for i, v in pairs(EffectsTable) do
                if not string.find(i, "Virus") and v.effects ~= nil and v.effects.currentduration ~= nil and
                    v.effects.colour ~= nil then
    ...
    if IsInTable({"infrun", "permrun", "runforever", "run", "uninfrun", "unpermrun", "unrunforever", "unrun"},
        Args.Command) then
        local Toggle = true -- last second to default to true, rather than a toggle
        if Args[1] == "true" or Args[1] == "on" then
            Toggle = true
    ...
    if IsInTable({"nocooldown", "removecooldown", "nocool", "instantcharge", "nocool", "cooldown", "unnocooldown",
                  "unremovecooldown", "unnocool", "uninstantcharge", "unnocool"}, Args.Command) then
        local Toggle = true -- last second to default to true, rather than a toggle
        if Args[1] == "true" or Args[1] == "on" then
            Toggle = true
        elseif Args[1] == "false" or Args[1] == "off" or string.sub(Args.Command, 1, 2) == "un" or Args.Command ==
            "cooldown" then
            Toggle = false
        end
            ...
            for i, v in pairs(TargetTable) do
                if typeof(v) == "table" and v["cooldown"] ~= nil then
                    for x, y in pairs(v) do
                        ...
                        if x == "perk_mincd" or x == "vulka_ammo_usage" or string.find(tostring(x), "overheat") or x ==
                            "goggle_broken_cd" or x == "damage_taken_multi" then
    ...
    if IsInTable({"cig", "ciggy", "cigarette", "smoke"}, Args.Command) then
        ...
        repeat
            wait()
        until game.Players.LocalPlayer.Character.Head:FindFirstChild("buffer_head")
    ...
    if IsInTable({"resetvirus", "pill", "pills", "resetinfection", "restartvirus", "restartinfection", "virusprogress",
                  "infectionprogress"}, Args.Command) then
        for i, v in pairs(EffectsTable) do
    ...
    if IsInTable({"oneshot", "instantkill", "instakill", "onetap", "infdamage", "unoneshot", "uninstantkill",
                  "uninstakill", "unonetap", "uninfdamage"}, Args.Command) then
        local Toggle = true -- last second to default to true, rather than a toggle
        if Args[1] == "true" or Args[1] == "on" then
            Toggle = true
        elseif Args[1] == "false" or Args[1] == "off" or string.sub(Args.Command, 1, 2) == "un" then
    ...
    if IsInTable({"silentaim", "alwayshit", "nevermiss", "aimbot", "unsilentaim", "unalwayshit", "unnevermiss",
                  "unaimbot"}, Args.Command) then
        local Toggle = true -- last second to default to true, rather than a toggle
        if Args[1] == "true" or Args[1] == "on" then
            Toggle = true
        elseif Args[1] == "false" or Args[1] == "off" or string.sub(Args.Command, 1, 2) == "un" then
    ...
    if IsInTable({"infammo", "infiniteammo", "infreserve", "infinitereserve", "uninfammo", "uninfiniteammo",
                  "uninfreserve", "uninfinitereserve"}, Args.Command) then
        local Toggle = true -- last second to default to true, rather than a toggle
        if Args[1] == "true" or Args[1] == "on" then
            Toggle = true
        elseif Args[1] == "false" or Args[1] == "off" or string.sub(Args.Command, 1, 2) == "un" then
    ...
    if IsInTable({"nofall", "nofalldamage", "antifalldamage", "antifall", "unnofall", "unnofalldamage",
                  "unantifalldamage", "unantifall", "falldamage"}, Args.Command) then
        local Toggle = true -- last second to default to true, rather than a toggle
        if Args[1] == "true" or Args[1] == "on" then
            Toggle = true
        elseif Args[1] == "false" or Args[1] == "off" or string.sub(Args.Command, 1, 2) == "un" or Args.Command ==
    ...
    if IsInTable({"grenaderain", "naderain", "rainnade", "rainnades", "nadesrain", "raingrenades", "raingrenade",
                  "grenadesrain", "ungrenaderain", "unnaderain", "unrainnade", "unrainnades", "unnadesrain",
                  "unraingrenades", "unraingrenade", "ungrenadesrain"}, Args.Command) then
        local Toggle = true -- last second to default to true, rather than a toggle
    ...
    if IsInTable({"equipbackpack", "backpack", "enablebackpack", "expandinventory", "addbackpack"}, Args.Command) then
        ...
        for i, v in pairs(TempUpValues) do
            if typeof(v) == "table" and v[1] ~= nil and typeof(v[1]) == "table" and typeof(v[1][1]) == "string" and
                typeof(v[1][2]) == "boolean" then
                v[5] = {"Fist", false, nil}
                v[6] = {"Fist", false, nil}
            end
        end
                        ...
                        if x ~= 1 and y[1] == "Fist" then
                            if Type == "Gun" then
                                if v == "LSMini" then
                                    ...
                                    local MaxAmmo = 10
                                    if game.ReplicatedStorage.Weapons:FindFirstChild(v) and
                                        game.ReplicatedStorage.Weapons[v]:FindFirstChild("ammo") then
    ...
    if IsInTable(
        {"setuse", "setuses", "uses", "setammo", "setmag", "mag", "arrows", "arrow", "ammo", "clip", "setclip"},
        Args.Command) then
    ...
    if IsInTable({"loopdrop", "loopspawn", "droploop", "keepdropping", "spawnloop", "rapiddrop", "rapidspawn",
                  "unloopdrop", "unloopspawn", "undroploop", "unkeepdropping", "unspawnloop", "unrapiddrop",
                  "unrapidspawn"}, Args.Command) then
        local Toggle = true -- last second to default to true, rather than a toggle
    ...
    if game.PlaceId ~= 9880062154 and not game.Workspace:FindFirstChild("HoldoutDecor") then
        repeat
            ...
            if game.Players.LocalPlayer.PlayerGui:FindFirstChild("mainHUD") and
                ...
                game.Players.LocalPlayer.PlayerGui.mainHUD.HealthFrame:FindFirstChild("Statuses") then
...
repeat
    wait()
until game.Workspace:FindFirstChild("ServerStuff")
repeat
    wait()
until game.Workspace.ServerStuff:FindFirstChild("Statistics")
repeat
    wait()
until game.Workspace.ServerStuff.Statistics:FindFirstChild("W_STATISTICS")
WeaponStats = require(game.Workspace.ServerStuff.Statistics.W_STATISTICS)

repeat
    wait()
until game.Workspace:FindFirstChild("Interactables")
